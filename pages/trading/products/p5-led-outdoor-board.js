    ...
    <div>
      ...
      <Container>
        <div className="mt-5 grid place-items-center">
          <h1 className="text-5xl text-center my-8">P5 LED OUTDOOR BOARD</h1>
          <div className="py-5 text-lg">
            <img
              class="rounded-t-lg h-80 w-96 object-cover m-auto"
              src="/product/ultraledseries/p5-led-outdoor-board.jpeg"
              alt=""
            />
            ...
            <ul className="list-disc ml-10">
              ...
              <li className="text-xl my-1">
                It can be reached 75 degrees for horizontal & vertical viewing
                angles;
              </li>
              <li className="text-xl my-1">
            ...
            <table class="table-auto">
              ...
              <tbody class="bg-white">
                <tr class="text-gray-700">
                  ...
                  <td class="px-4 py-3 text-lg border">5mm</td>
                </tr>
                <tr class="text-gray-700">
                  <td class="px-4 py-3 text-lg border">Lamp</td>
                  <td class="px-4 py-3 text-lg border">SMD272</td>
                </tr>
                <tr class="text-gray-700">
                  <td class="px-4 py-3 text-lg border">
                    Pixel Density Dots/m2
                  </td>
                  <td class="px-4 py-3 text-lg border">40000</td>
                </tr>
                <tr class="text-gray-700">
