    ...
    <div>
      ...
      <Container>
        <div className="mt-5 grid place-items-center">
          <h1 className="text-5xl text-center my-8">P2 INDOOR DISPLAY BOARD</h1>
          <div className=" py-5 text-lg">
            <img
              class="rounded-t-lg h-80 w-96 object-cover m-auto"
              src="/product/ultraledseries/p2-indoor-display-board.jpg"
              alt=""
            />
            <h1 className="text-4xl my-6">Description</h1>
            <p className="text-xl mb-4">
              Product name (Product name): Indoor P2 full-color module <br />
              <br />
              Product model (Product model): M-P2F321515M-M12864SA1 <br />
              <br />
              Spacing (Pixel Pitch): 2 mm <br />
              <br />
            ...
            <table class="table-auto">
              ...
              <tbody class="bg-white">
                <tr class="text-gray-700">
                  ...
                  <td class="px-4 py-3 text-lg border">2mm</td>
                </tr>
                <tr class="text-gray-700">
